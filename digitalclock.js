...
function greet()
{
    ...
    if(time>=5 && time<=12)
    {
        ...
        document.getElementById("vid").src="./morningvid.mp4"
    ...
    else if(time>=12 && time<=16)
    {
        ...
        document.getElementById("vid").src="./afternoonvid.mp4"
    }
    else if(time>=16 && time<=20)
    {
        document.getElementById("message").innerHTML="Good Evening...!!"
        document.getElementById("vid").src="./eveningvid.mp4"
    ...
    else 
    {
        ...
        document.getElementById("vid").src="./nightvid.mp4"
        document.getElementById("container").style.backgroundColor="rgba(0,0,0,0.57)"
        document.getElementById("Time").style.color="white"
        document.getElementById("Date").style.Color="wheat"
        document.getElementById("Day").style.Color="wheat"
